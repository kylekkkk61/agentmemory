...
export const V010_SLOTS_TOOLS: McpToolDef[] = [
  {
    ...
    inputSchema: {
      type: "object",
      properties: {
        project: { type: "string", description: "Stable project slug whose project-scoped slots should be resolved" },
      },
    },
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        project: { type: "string", description: "Stable project slug for project-scoped slot resolution" },
      },
      required: ["label"],
    },
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        project: { type: "string", description: "Required when scope='project'. Stable project slug that owns this slot." },
      },
      required: ["label"],
    },
  },
